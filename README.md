...
Entradas: São os dados e sinais fornecidos ao sistema. No caso do ASRS, incluem a autenticação via RFID (para controle de acesso) e a interação com o utilizador.
